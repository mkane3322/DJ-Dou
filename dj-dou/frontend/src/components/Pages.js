...
import { useAuthCtx, useDNA, useRecommendations } from "../lib";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          DJ Dou analyzes 13 audio dimensions from your Spotify history to
          generate a unique SoundDNA — powering recommendations that actually
          sound like you.
        </p>
        <button
          className="fu3"
          ...
          {[
            {
              ...
              desc: "13-dimension fingerprint from your top Spotify tracks across all time ranges.",
            },
            {
              icon: "🤖",
              title: "AI Summary",
              desc: "Claude writes a plain-English portrait of your musical identity.",
            },
            {
              icon: "🎯",
              title: "Smart Recs",
              desc: "Cosine similarity finds tracks that genuinely match your audio fingerprint.",
            },
            {
              icon: "🌙",
              title: "Mood Search",
              desc: "Type a vibe — AI parses it into audio feature ranges to find the perfect track.",
            },
          ].map((f) => (
    ...
    >
      ...
      >
        ...
        >
          ...
          13-dimension audio fingerprint powering hyper-accurate
          recommendations.
        </p>
        <button
          onClick={login}
        ...
        {dnaLoading ? (
          ...
          >
            ...
            >
              ...
              >
                Analyze your Spotify history across 13 audio dimensions to build
                your unique musical fingerprint.
              </p>
              <button
                onClick={computeDNA}
                disabled={computing}
            ...
            <div className="glass fu2" style={{ padding: "1.5rem" }}>
              <SeedsManager />
            </div>
          </div>
        ) : (
            ...
            <section className="fu4">
              ...
              {recsLoading ? (
                ...
                <EmptyState
                  ...
                  desc="Your catalog is still indexing. Give it a few minutes."
                  action={{
                    label: "Try again",
                    onClick: () => fetchRecommendations(true),
                  }}
    ...
    <div style={{ paddingTop: "2rem", paddingBottom: "5rem" }}>
      <div className="container">
        <header className="fu" style={{ marginBottom: "2rem" }}>
          ...
          >
            Describe how you want to feel. Claude parses your mood into audio
            feature filters, then matches tracks to your SoundDNA.
          </p>
        </header>
        <div
          className="glass fu1"
        ...
        {moodResults && !moodLoading && (
          <div className="fu">
            {moodResults.parsedFilters &&
              Object.keys(moodResults.parsedFilters).length > 0 && (
                <div
                  style={{
                    display: "flex",
                    alignItems: "center",
                ...
                >
                  ...
                  {Object.entries(moodResults.parsedFilters).map(
                    ([k, [mn, mx]]) => (
                      <span
                        key={k}
                        style={{
        ...
        {!moodResults && !moodLoading && (
          <EmptyState
            ...
            desc="Type a description or pick a preset above to find tracks that match your vibe and your SoundDNA."
          />
        )}
      </div>
    </div>
