    ...
    <div style={{ paddingTop:'2rem', paddingBottom:'5rem' }}>
      <div className="container">
        <header className="fu" style={{ marginBottom:'2rem' }}>
          ...
          <p style={{ color:'var(--text-secondary)', fontSize:'0.9rem', lineHeight:1.7, maxWidth:500 }}>Describe how you want to feel. Claude parses your mood into audio feature filters, then matches tracks to your SoundDNA.</p>
        </header>
          ...
          {dna ? (
            <>
              <div style={{ display:'flex', alignItems:'center', gap:'8px', color:'var(--text-secondary)', fontSize:'0.875rem', marginBottom:'0.75rem' }}>
                <span style={{ width:8, height:8, borderRadius:'50%', background:'var(--accent-lime)', boxShadow:'0 0 8px var(--accent-lime)', display:'inline-block' }} />
